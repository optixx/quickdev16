...
*/
	...
	#define HW_ENDPOINT_AT91_SD
	/* define the chip-select line in at91_spi.c */
...
/*
 * mthomas: define the attribute for packed structures
 *          to avoid alignment problems with ARM controllers
*/
	#define ATTR_PACKED __attribute__((packed)) /* ARM */
